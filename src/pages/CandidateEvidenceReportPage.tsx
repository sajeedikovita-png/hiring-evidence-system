      ...
      <main className="workspace-content">
        ...
        {isDemoReport ? (
          evidenceReport.generatedAt.startsWith("AI") ? (
            <WarningCard title="AI-generated report">
              This evidence report was generated by AI from your uploaded résumé. It is saved in your browser for this demo, not
              yet in a shared company workspace.
            </WarningCard>
          ) : (
            <WarningCard title="Demo preview report">
              ...
              real AI parsing of the document. It is saved in your browser for this demo.
            </WarningCard>
          )
        ) : null}
